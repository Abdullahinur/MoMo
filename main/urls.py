...
urlpatterns = [
    ...
    url(r'^view profile/liked$', views.like_post_other_profile,
        name='like_post_other_profile'),
    url(r'^view profile/MsgSent$', views.send_msg_other_profile,
        name='send_msg_other_profile'),
